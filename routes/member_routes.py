...
create_member_model = member_routes.model("Add",{
...
membership_model = member_routes.model("membership",{
    "member_id": fields.Integer(required=True, description="member id"),
    "membership_type": fields.String(required=True, description="1 week / 1 month / 6 month / 1 year")
})
# show member
show_all_member = Namespace("members",description="show all members", path="/member")

#update member
update_member_model = member_routes.model("update",{
...
class SearchMember(Resource):
    @member_routes.doc(params={
        "membership_type": "1 week / 1 month / 6 month / 1 year",
        "page": {"description" : "page number",
                 "type": "int",
                 "default":1},

        "per_page": {"description" : "page number",
                     "type" : "int",
                     "default":4}
