...
if page == "Overview":
    ...
    with tab1:
        st.markdown(
            '<div class="gradient-subheader">Books Summary</div>',
            unsafe_allow_html=True,
        )
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if books:
                    ...
                    st.markdown(
                        '<div class="gradient-subheader">Book Distribution by Category</div>',
                        unsafe_allow_html=True,
                    )
                    ...
                    if not category_counts.empty:
                        ...
                        with center_col:
                            # Set figure facecolor to transparent to blend with Streamlit's background
                            fig, ax = plt.subplots(figsize=(6, 4), facecolor="none")

                            # Updated color palette to match your sidebar CSS (Blues & Purples)
                            colors = [
                                "#3b82f6",
                                "#8b5cf6",
                                "#60a5fa",
                            ...
                            ax.pie(
                                ...
                                wedgeprops={
                                    "edgecolor": "#0f172a",
                                    "linewidth": 2,
                                },  # Dark background edge to separate slices
                            )
                            ax.axis("equal")
